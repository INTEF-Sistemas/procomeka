import{g as l}from"./get-api-client.8Dtny595.js";import{u}from"./paths.DDXL0-p6.js";import"./preload-helper.BKXYl-sz.js";const s=document.getElementById("resources-list"),n=document.getElementById("search");async function i(a=""){try{const c=await l(),{data:t,total:r}=await c.listResources(a?{q:a}:void 0);if(t.length===0){s.innerHTML="<p>No se encontraron recursos.</p>";return}s.innerHTML=t.map(e=>`
