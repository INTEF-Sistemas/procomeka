import{g as l}from"./get-api-client.ClCyC4ig.js";import{u as n}from"./paths.DDXL0-p6.js";import"./preload-helper.BKXYl-sz.js";const r=document.getElementById("collection-form"),i=document.getElementById("collections-body");async function d(){const a=await l(),o=await a.listCollections({limit:100,offset:0});i.innerHTML=o.data.map(t=>`
			<tr>
