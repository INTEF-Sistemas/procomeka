import{g as l}from"./get-api-client.DBgXoPud.js";import{u}from"./paths.DDXL0-p6.js";import"./preload-helper.BKXYl-sz.js";const a=document.getElementById("taxonomy-body"),o=document.getElementById("taxonomy-form");async function n(){const d=await l(),i=await d.listTaxonomies({limit:100,offset:0});a.innerHTML=i.data.map(t=>`
			<tr>
