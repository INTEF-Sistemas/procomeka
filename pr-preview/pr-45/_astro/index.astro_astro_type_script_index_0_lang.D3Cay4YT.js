import{g as r}from"./get-api-client.w_qaBL6_.js";import{u as c}from"./paths.DDXL0-p6.js";import"./preload-helper.CPZg4Qqv.js";const e=document.getElementById("users-body"),s=document.getElementById("users-status"),u=document.getElementById("search"),m=document.getElementById("role-filter");async function o(){const d=await r(),i=await d.listUsers({q:u.value||void 0,role:m.value||void 0,limit:50,offset:0});s.textContent=`${i.total} usuarios visibles`,e.innerHTML=i.data.map(t=>`
			<tr>
