const E=[`CREATE TABLE IF NOT EXISTS "user" (
		...
		created_at TIMESTAMP NOT NULL DEFAULT NOW(),
		updated_at TIMESTAMP NOT NULL DEFAULT NOW()
	)`,"CREATE INDEX IF NOT EXISTS idx_resources_slug ON resources(slug)","CREATE INDEX IF NOT EXISTS idx_resources_status ON resources(editorial_status)","CREATE INDEX IF NOT EXISTS idx_resources_type ON resources(resource_type)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_resource_id ON upload_sessions(resource_id)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_owner_id ON upload_sessions(owner_id)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_status ON upload_sessions(status)","CREATE INDEX IF NOT EXISTS idx_taxonomies_type ON taxonomies(type)",`DO $$ BEGIN
...
`;async function a(T){for(const e of E)await T.exec(e);await T.exec(N)}export{E as SCHEMA_STATEMENTS,a as createTables};
